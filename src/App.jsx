...
const PRODUCTS = [
  {
    id: 76, cat: "heli", status: "avail",
    name: "玛雅湾直升机探索之旅", nameEn: "Maya Bay Discovery Helicopter Tour",
    emoji: "🚁",
    images: [
      "https://i.ibb.co/1G5Vc2jX/large-634-A1400-resized-a018c471b9.jpg",
      "https://i.ibb.co/Z6GyWxBX/large-634-A1139-resized-289554790c.jpg",
      "https://i.ibb.co/wZRXT4S3/large-634-A1292-resized-14f4b70038.jpg",
      "https://i.ibb.co/MxPrkvt8/large-634-A1302-resized-7c69fc02f0.jpg",
      "https://i.ibb.co/CKzXK2yq/large-634-A1398-resized-0f22e28a9c.jpg",
      "https://i.ibb.co/39gVWYQP/large-634-A1443-resized-1-0756f8d1a0.jpg",
      "https://i.ibb.co/XxssrKsX/large-634-A1467-resized-b853cc4f57.jpg",
      "https://i.ibb.co/TDK04L8Z/large-634-A1470-resized-b12426aae5.jpg",
      "https://i.ibb.co/qPzHH99/large-634-A1488-resized-bbc367e0d7.jpg",
      "https://i.ibb.co/PZbhtbKq/large-634-A1632-resized-6cdfdbbb5a.jpg",
      "https://i.ibb.co/W4f1f2Cq/large-SSA-Route-Map-MAYA-BAY-DISCOVERY-1603e4b80c.jpg",
      "https://i.ibb.co/KjJGq2f7/large-SSA-Route-Map-MAYA-BAY-DISCOVERY-Map-Only-cf6354dcd7.jpg",
    ],
    desc: "50分钟玛雅湾直升机探索，飞入皮皮岛群岛核心，从空中俯瞰洁白沙滩、碧绿海水与高耸石灰岩峭壁。宁静纯净、电影般的视角，是整个安达曼海最令人难忘的景色之一。",
    retail: 23500, agent: 22000, cost: 21000,
    includes: [
      "50分钟直升机观光飞行",
      "专业飞行员",
      "玛雅湾全景空中俯瞰",
    ...
    suppliers: [
      { name: "SILKSKY", price: 21000 },
    ],
    notes: [
      "价格为每座计费",
      "出发地点将与预订专员确认",
      "行程约50分钟，是所有路线中时长最长的",
      "专为想以电影级视角欣赏玛雅湾而不被人群打扰的旅客设计",
      "皮皮岛玛雅湾是《海滩》电影拍摄地，极具标志性",
      "建议提前预约，天气原因可能影响飞行安排",
    ],
    faq: [
      { q: "飞行时长是多少？", a: "约50分钟，是所有直升机观光路线中时长最长的，可充分欣赏玛雅湾及皮皮岛群岛。" },
      { q: "价格是怎么计算的？", a: "按每座计费，市场价23,500泰铢/座。" },
      { q: "玛雅湾有什么特别的？", a: "玛雅湾是《海滩》电影拍摄地，洁白沙滩、碧绿海水与高耸石灰岩峭壁构成绝美画卷，从空中俯瞰更显壮丽。" },
      { q: "和地面游览有什么不同？", a: "从空中俯瞰完全不同的视角，宁静纯净，没有人群拥挤，每个角度都是绝佳拍摄机会。" },
      { q: "出发地点在哪里？", a: "具体出发地点将与预订专员确认，请提前联系安排。" },
    ],
    itinerary: "出发地点登机 → 沿翡翠海岸线飞入皮皮岛群岛 → 玛雅湾全景俯瞰 → 石灰岩峭壁及碧绿海水观光 → 皮皮岛群岛探索 → 返航",
    materials: [
      "玛雅湾直升机观光实拍图及航线图12张",
      "小红书推广文案（玛雅湾电影级视角版）",
      "朋友圈推广文案",
  ...
  },
  {
    ...
    notes: [
      ...
      "可定制体验：专属礼宾、私人活动、纪念日策划、求婚安排、VIP体验、私人晚宴、高端资源协调、个性化行程",
      "完全开放式定制，任何网站未展示的需求均可咨询",
      "建议尽早联系以便充分沟通需求细节",
    ],
    faq: [
      { q: "我的需求很特别，可以咨询吗？", a: "完全可以！这正是特别安排的定位，任何网站未展示的个性化需求都欢迎与隐海顾问沟通。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据具体需求复杂度、资源协调难度等综合评估后给出报价。" },
      { q: "需要提供哪些信息？", a: "旅行日期、天数、同行人数、预算偏好、旅行目的、详细需求描述、其他特别需求。" },
      { q: "可以实现哪些特殊需求？", a: "求婚策划、VIP贵宾体验、私人晚宴、纪念日庆祝、高端资源协调等均可定制，欢迎详细沟通。" },
    ],
    itinerary: "详细沟通需求（旅行日期/天数/人数/预算/旅行目的/需求描述）→ 评估可行性 → 定制专属方案 → 确认细节 → 旅程执行",
    materials: [
      "特别安排概念图1张",
      "小红书推广文案（专属定制版）",
      "朋友圈推广文案",
  ...
  {
    id: 69, cat: "custom", status: "avail",
    name: "海岛狂欢", nameEn: "Island Celebration",
    emoji: "✨",
    images: [
    ...
    notes: [
      ...
      "可定制体验：游艇派对、泳池别墅、Beach Club、DJ派对、私人晚宴、庆典布置、摄影摄像、灯光音响、烟花策划",
      "完全定制化产品，需先沟通需求再出具体方案",
      "烟花需依当地法规审批，建议提前1个月联系",
    ],
    faq: [
      { q: "需要提前多久预约？", a: "建议提前1个月联系，涉及烟花、场地预订等需更充足的筹备时间。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据场地、活动内容、人数等具体需求组合后给出报价。" },
      { q: "可以放烟花吗？", a: "可以协助申请，但需依当地法规审批，建议提前沟通确认可行性。" },
      { q: "需要提供哪些信息？", a: "活动日期、时长、参与人数、预算偏好、活动场地、活动内容、庆祝主题、特别需求。" },
    ],
    itinerary: "沟通需求（活动日期/时长/人数/预算/场地/内容/主题）→ 定制专属方案 → 确认细节 → 现场布置执行 → 摄影摄像记录精彩时刻",
    materials: [
      "海岛狂欢概念图1张",
      "小红书推广文案（派对庆典版）",
      "朋友圈推广文案",
  ...
  {
    id: 68, cat: "custom", status: "avail",
    name: "挚友同行", nameEn: "Friends' Escape",
    emoji: "✨",
    images: [
    ...
    notes: [
      ...
      "可定制体验：游艇出海、ATV越野、海钓体验、高尔夫、Beach Club、酒吧体验、私人别墅、特色餐厅、包车服务",
      "完全定制化产品，需先沟通需求再出具体方案",
      "建议提前2-4周联系以便充分筹备",
    ],
    faq: [
      { q: "需要提前多久预约？", a: "建议提前2-4周联系，特殊场地或热门日期建议更早安排。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据活动、住宿、人数等具体需求组合后给出报价。" },
      { q: "可以策划生日或庆祝活动吗？", a: "可以！如涉及生日、聚会等庆祝活动，提前告知我们会协助安排惊喜环节。" },
      { q: "需要提供哪些信息？", a: "旅行日期、天数、同行人数、预算偏好、住宿偏好、体验偏好、特别时刻、特别需求。" },
    ],
    itinerary: "沟通需求（旅行日期/天数/人数/预算/住宿/体验偏好/特别时刻）→ 定制专属方案 → 确认细节 → 旅程执行 → 尽兴体验男士度假/好友聚会",
    materials: [
      "挚友同行概念图1张",
      "小红书推广文案（好友出游版）",
      "朋友圈推广文案",
  ...
  {
    id: 67, cat: "custom", status: "avail",
    name: "商务礼宾", nameEn: "Executive Concierge",
    emoji: "✨",
    images: [
    ...
    notes: [
      ...
      "可定制体验：机场礼遇、豪华用车、商务酒店、私人游艇、会议安排、礼宾服务、高端餐厅、商务翻译、行程协调",
      "完全定制化产品，需先沟通需求再出具体方案",
      "建议提前2-3周联系以便充分筹备商务行程",
    ],
    faq: [
      { q: "需要提前多久预约？", a: "建议提前2-3周联系，会议或团体接待需更早安排以保证服务质量。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据用车、住宿、会议规模等具体需求组合后给出报价。" },
      { q: "可以提供翻译和秘书服务吗？", a: "可以！商务翻译、秘书服务、行程协调均可按需安排。" },
      { q: "需要提供哪些信息？", a: "抵达日期、停留时间、同行人数、预算偏好、住宿偏好、商务需求、礼宾需求、特别需求。" },
    ],
    itinerary: "沟通需求（抵达日期/停留时间/人数/预算/商务需求/礼宾需求）→ 定制专属方案 → 确认细节 → 行程执行 → 全程礼宾协调服务",
    materials: [
      "商务礼宾概念图1张",
      "小红书推广文案（商务接待版）",
      "朋友圈推广文案",
  ...
  {
    id: 66, cat: "custom", status: "avail",
    name: "家庭雅游", nameEn: "Family Retreat",
    emoji: "✨",
    images: [
    ...
    notes: [
      ...
      "可定制体验：私人别墅、游艇体验、包车服务、家庭摄影、岛屿探索、特色餐厅、礼宾服务",
      "完全定制化产品，需先沟通需求再出具体方案",
      "建议提前2-4周联系以便充分筹备",
    ],
    faq: [
      { q: "需要提前多久预约？", a: "建议提前2-4周联系，特殊场地或热门日期建议更早安排。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据住宿、活动、人数等具体需求组合后给出报价。" },
      { q: "可以照顾长辈需求吗？", a: "可以！如有长辈照顾需求、无障碍安排等，提前告知我们会协助安排。" },
      { q: "需要提供哪些信息？", a: "旅行日期、天数、同行人数（是否有长辈/儿童）、预算偏好、住宿偏好、体验偏好、特别需求。" },
    ],
    itinerary: "沟通需求（旅行日期/天数/人数/预算/住宿/体验偏好/特别需求）→ 定制专属方案 → 确认细节 → 旅程执行 → 家庭摄影记录团聚时光",
    materials: [
      "家庭雅游概念图1张",
      "小红书推广文案（多代同游版）",
      "朋友圈推广文案",
  ...
  {
    id: 65, cat: "custom", status: "avail",
    name: "悦享亲子", nameEn: "Family Moments",
    emoji: "✨",
    images: [
    ...
    notes: [
      ...
      "可定制体验：私人别墅、儿童乐园、动物互动、游艇体验、包车出行、家庭摄影、海岛探索、儿童用品安排",
      "完全定制化产品，需先沟通需求再出具体方案",
      "建议提前2-4周联系以便充分筹备",
    ],
    faq: [
      { q: "需要提前多久预约？", a: "建议提前2-4周联系，特殊场地或热门日期建议更早安排。" },
      { q: "费用怎么计算？", a: "标价为客制化起价，最终费用根据住宿、活动、人数等具体需求组合后给出报价。" },
      { q: "可以提供儿童用品吗？", a: "可以！如需儿童座椅、婴儿用品、中文司机等，提前告知我们会协助安排。" },
      { q: "需要提供哪些信息？", a: "旅行日期、天数、同行人数（是否有老人或儿童）、预算偏好、住宿偏好、体验偏好、特别需求。" },
    ],
    itinerary: "沟通需求（旅行日期/天数/人数/预算/住宿/体验偏好/特别需求）→ 定制专属方案 → 确认细节 → 旅程执行 → 家庭摄影记录温馨时光",
    materials: [
      "悦享亲子概念图1张",
      "小红书推广文案（亲子家庭版）",
      "朋友圈推广文案",
