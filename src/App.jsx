...
images: [
  ...
  },
  {
    ...
    desc: "胶片感·电影感·自然情绪·松弛状态。Sony a7m4+CCD+iPhone 17 Pro三机拍摄，注重人与环境的真实连接。单人/群像/亲子/纪实/旅拍多种风格，底片全送+精修交付。",
    retail: 18500, agent: 16650, cost: 14800,
    includes: [
      "1H：80+底片全送，5张精修（3,200 THB）",
      "2H：180+底片全送，10张精修（5,700 THB）",
      "半天4H：300+底片全送，15张精修（10,000 THB）",
      "全天/跨岛8H：600+底片全送，24张精修（18,500 THB）",
      "Sony a7m4+CCD+iPhone 17 Pro三机拍摄",
      "百度网盘底片交付（24H内）",
      "选片后48H内返精修图",
    ],
    excludes: [
      "额外精修（100 THB/张）",
      "交通费（卡马拉300/芭东卡伦卡塔500/拉威麦考900 THB）",
      "场地费/门票费/餐食费（提前告知）",
      "多人加拍（500 THB/人）",
      "短视频剪辑调色（另行报价）",
    ],
    ...
    notes: [
      ...
      "多人拍摄每人加500泰铢",
      "50%定金确认订单，拍摄结束付尾款",
      "可免费改期，4天前取消全退，48H前退50%，48H内不退定金",
      "默认照片可发布各平台，介意请提前告知",
    ],
    faq: [
      { q: "拍摄风格是什么？", a: "胶片感、电影感、自然情绪、松弛状态，注重人与环境的真实连接，捕捉自然流露的瞬间。" },
      { q: "用什么设备拍摄？", a: "Sony a7m4、佳能ixus210机皇CCD、iPhone 17 Pro，三机拍摄，底片全送。" },
      { q: "多人拍摄怎么收费？", a: "以上为1人价格，多一人加500泰铢/人。" },
      { q: "照片什么时候交付？", a: "尾款付清后24H内发送底片（百度网盘），自行选片后48H内返精修图。" },
      { q: "可以取消或改期吗？", a: "可免费改期。取消：4天前全退，48H前退50%，48H内定金不退。" },
    ],
    itinerary: "提前沟通时间/地点/风格 → 支付50%定金确认 → 拍摄当天按约定时间开始计时 → 结束后付尾款 → 24H内收底片 → 选片后48H内收精修图",
    materials: [
      "旅拍样片10张",
      "小红书推广文案（胶片情绪旅拍版）",
      "朋友圈推广文案",
